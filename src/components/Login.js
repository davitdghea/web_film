  ...
  return (
      <div className=' flex justify-center items-center' >
          ...
          <div className='  text-white  flex flex-col justify-center items-center absolute'>
              ...
              <Link to={path.PUBLIC}><Button title="Log in" customStyle="px-[98px] py-[17px]" /></Link>
              <span className='mt-[16px]'>No account?<a href="#" className="text-blue-400 underline">Sign up</a></span>
          </div>
    </div>
