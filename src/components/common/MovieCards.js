...
const MovieCards = ({ onFavourites, customStyle, title, date, img, idFilm, onCartClick, LinkYouToBeClick, LinkYouToBe }) => {
    return (
        <div onClick={() => { onCartClick(idFilm); LinkYouToBeClick(LinkYouToBe) }} className={`${customStyle}  bg-red-300  rounded-2xl relative mx-auto mt-[16px] z-0`}>
